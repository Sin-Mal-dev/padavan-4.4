												...
												<div id="vpnc_settings" class="contentM_qis"
													...
													<table width="100%" cellpadding="4" cellspacing="0" class="table"
														...
														<tr>
															...
															<td>
																<select name="ssp_type" id="ssp_type" class="input"
																	...
																	<option value="xray">Vmess</option>
														...
														<tr id="row_v2_httpupgrade_host" style="display:none;">
															...
															<td>
																<input type="text" class="input" size="15"
																	name="v2_httpupgrade_host" id="v2_httpupgrade_host"
																	style="width: 200px"
																	value="<% nvram_get_x("","v2_httpupgrade_host_x_0"); %>" />
															</td>
														</tr>
														<tr id="row_v2_httpupgrade_path" style="display:none;">
															...
															<td>
																<input type="text" class="input" size="15"
																	name="v2_httpupgrade_path" id="v2_httpupgrade_path"
																	style="width: 200px"
																	value="<% nvram_get_x("","v2_httpupgrade_path_x_0"); %>" />
															</td>
														</tr>
														<tr id="row_v2_splithttp_host" style="display:none;">
															...
															<td>
																<input type="text" class="input" size="15"
																	name="v2_splithttp_host" id="v2_splithttp_host"
																	style="width: 200px"
																	value="<% nvram_get_x("","v2_splithttp_host_x_0"); %>" />
															</td>
														</tr>
														<tr id="row_v2_splithttp_path" style="display:none;">
															...
															<td>
																<input type="text" class="input" size="15"
																	name="v2_splithttp_path" id="v2_splithttp_path"
																	style="width: 200px"
																	value="<% nvram_get_x("","v2_splithttp_path_x_0"); %>" />
															</td>
														</tr>
